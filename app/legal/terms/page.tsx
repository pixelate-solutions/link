...
const Terms = () => {
  return (
    <div className="container mx-auto p-4 bg-white/60 rounded-2xl z-50 mt-[40px] mb-[40px]">
      <h1 className="text-3xl font-bold mb-4 rounded-2xl">Terms and Conditions</h1>
      <p className="text-sm text-gray-600">Effective Date: February 22, 2025</p>
      ...
      <p>
        Your data is used to provide and improve the Service. It may be stored on third-party servers as outlined above, and by using the Service, you consent to the collection, storage, and processing of your data according to our Privacy Policy.
      </p>
      ...
      <h2 className="text-2xl font-semibold mt-8">6. Personalized Financial Guidance</h2>
      <p>
        By using the Finance Guide feature of the Service, you consent to the processing of your financial data to generate personalized, data-driven insights and responses tailored to your financial behavior and needs. These tailored responses are provided for informational purposes only and do not constitute professional financial advice. You acknowledge that you are solely responsible for verifying any information before making financial decisions, and LinkLogic LLC shall not be liable for any errors, omissions, or losses arising from the use of such personalized content.
      </p>
