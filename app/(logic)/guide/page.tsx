...
const presetOptions = [
  ...
  "Should I prioritize saving or paying off my debt first?",
...
const LogicPage = () => {
  ...
  return (
    <div className={cn("min-h-screen bg-white", montserratP.className)}>
      {/* Header */}
      <div className="sticky top-[137px] -mt-[130px] bg-gradient-to-br from-blue-200 to-purple-200 lg:w-[74%] lg:ml-[13%] h-[100px] rounded-t-2xl z-50 flex items-center justify-center">
          ...
          {selectedQuestion && (
            ...
            >
              <div className="mb-4">
                ...
                {/* Use the Typewriter component for the question */}
